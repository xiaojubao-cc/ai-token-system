...
public class TyySignUtil {
     ...
     * @return
     */
    public Response requestTyyServer(String url,String method,String jsonBody){
        ...
        YunSign yunSign = new YunSign(requestUrl, tyyProperties.getAccessKey(), tyyProperties.getSecurityKey(),
                requestId, jsonBody, 0, "application/json", (String)null, null);
        log.info("【请求天翼云网关服务请求体:{}】", JSONUtil.toJsonStr(yunSign));
        Response response = yunSign.toDo(method);
        ...
        if(StringUtils.isNotBlank(response.getBody())){
            ...
            Response bean = JSONUtil.toBean(bodyString, Response.class);
            return bean;
        }
        return response;
    }
